...
class MemberBlock extends Component {
    ...
    render() {
        ...
        const color = member.account_status === 'platinum' ? '#e9e707' 
        ...
        var approved_photos = 0
        for (var i = 0; i < member.photos.length; i++) {
            if (member.photos[i].approved) approved_photos++
        }
            ...
            <div className="wrap-member memberblock_mobile">
                ...
                <div className="first_wrap">
                    <div className="avatars_wrap" >
                        <img src={sexPhotoFinder(member.sex, approved_photos ? member.photos[0].path : null)} className="avatar_photo" />
                    ...
                    <div className="member-infos float-right">
                        <div style={{ color: '#747373' }} className="form-group member_id">
                            <strong>ID:</strong> {this.state.member.profile_id}
                        </div>
                ...
                {member.photos && <div className="first_content">
                    {
                    approved_photos ? (
                        <Slider ref={c1 => (this.slider_original = c1)} {...settings_original}>
                            {member.photos.map((el, idx) => (
                                el.approved && <div key={idx} index={idx} className="member_photo_wrap">
